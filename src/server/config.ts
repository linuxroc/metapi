...
export function buildConfig(env: NodeJS.ProcessEnv) {
  ...
  return {
    ...
    cloudflareTurnstileSiteKey: parseOptionalSecret(env.CLOUDFLARE_TURNSTILE_SITE_KEY),
    cloudflareTurnstileSecret: parseOptionalSecret(env.CLOUDFLARE_TURNSTILE_SECRET),
